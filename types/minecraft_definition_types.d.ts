...
// Generated on: Tue, 02 Jan 2024 22:19:38 GMT
...
"minecraft:selection_box"?:CA;
"minecraft:transformation"?:CB;
"minecraft:unit_cube"?:CC;
"minecraft:on_fall_on"?:CD;
"minecraft:on_interact"?:CE;
"minecraft:on_placed"?:CF;
"minecraft:on_player_destroyed"?:CG;
"minecraft:on_player_placing"?:CH;
"minecraft:on_step_off"?:CI;
"minecraft:on_step_on"?:CJ;
"minecraft:queued_ticking"?:DA;
"minecraft:random_ticking"?:DB;
};
...
export type CC=Record<string,never>;
export type CD={
/**
...
export type DC={
"minecraft:on_fall_on"?:DC_event_base;
"minecraft:on_interact"?:DC_event_base;
"minecraft:on_placed"?:DC_event_base;
"minecraft:on_player_destroyed"?:DC_event_base;
"minecraft:on_player_placing"?:DC_event_base;
"minecraft:on_step_off"?:DC_event_base;
"minecraft:on_step_on"?:DC_event_base;
[k:string]:any;
};
export type B={
/**
...
[k:string]:any;
}|BH|CA|CC|CD|CE|CF|CG|CH|CI|CJ|DA|DB|DC|DE|DF|DG|DH|DI|DJ|EA|EB|EC|ED|EE|EF|EG|EH|EI|EJ|FA|FB|FC|FD|FE|FF|FG|FH|FI|FJ|GA|GB|GC|GD|GE|GF|GG|GH|GI|GJ|HA|HB|HC|HD|HE|HF|HG|HH|HI|HJ|IA|IB|IC|ID|IE|IF|IG|IH|II|IJ|JA|JB|JC|JD|JE|JF|JG|JH|JI|JJ|BAA|BAB|BAC|JsonType;
...
export type BAF=Record<string,never>;
export type BAG={
/**
...
*/
"attack_cooldown_complete_event"?:BAI;
/**
*@default [0,1]
...
export type BBB=number|Array<JsonType>|{
/**
...
export type BBE=Record<string,never>;
...
*/
"breathe_blocks"?:Array<BCC>;
/**
*@description List of blocks this entity can't breathe in, in addition to the above.
*/
"non_breathe_blocks"?:Array<BCC>;
};
export type BCD_breeds_with_spec={
/**
...
export type BCF=Array<JsonType>;
export type BCD={
/**
...
*/
"breeds_with"?:BCD_breeds_with_spec|Array<BCD_breeds_with_spec>;
/**
...
*/
"environment_requirements"?:BCD_enviroment_requirements|Array<BCD_enviroment_requirements>;
/**
...
*/
"parent_centric_attribute_blending"?:Array<JsonType>;
/**
*@description Range used to determine random extra variant.
*/
"random_extra_variant_mutation_interval"?:BCF;
/**
*@description Range used to determine random variant.
*/
"random_variant_mutation_interval"?:BCF;
/**
*@default true
...
export type BCI=boolean|{
[k:string]:any;
};
export type BCJ=Record<string,never>;
export type BDA={
/**
*@default true
...
export type BDB=Record<string,never>;
export type BDC={
/**
*@default true
...
*/
"triggers"?:Array<BEA_triggers>|BEA_triggers;
};
export type BEB={
/**
*@default 1
...
export type BEI_trigger=BAI;
export type BEI={
/**
*@description The list of triggers that fire when the environment conditions match the given filter criteria.
*/
"triggers"?:Array<BEI_trigger>|BEI_trigger;
};
export type BEJ={
/**
...
export type BFH=Record<string,never>;
export type BFI=Record<string,never>;
export type BFJ={
/**
...
export type BGE_integer_range=integer|{
/**
...
*/
"allele_range"?:BGE_integer_range;
/**
...
*/
"item"?:J;
"effects"?:BGJ_effect|Array<BGJ_effect>;
[k:string]:any;
}>;
};
export type BHA={
...
export type BHC=Record<string,never>;
export type BHD={
/**
*@default -1
...
export type BIC_interaction_spec={
/**
...
*/
"interactions"?:BIC_interaction_spec|Array<BIC_interaction_spec>;
};
export type BID={
/**
...
export type BIF=Record<string,never>;
...
export type BII=Record<string,never>;
export type BIJ=Record<string,never>;
export type BJA=Record<string,never>;
export type BJB=Record<string,never>;
export type BJC=Record<string,never>;
export type BJD=Record<string,never>;
export type BJE={
/**
*@description UNDOCUMENTED.
*/
...
export type BJF=Record<string,never>;
export type BJG=Record<string,never>;
export type BJH={
/**
...
export type BJI=Record<string,never>;
export type BJJ=Record<string,never>;
export type CAA={
/**
*@default 0.42
...
export type CAG=Record<string,never>;
export type CAH={
/**
...
*/
"name_actions"?:Array<CCA_name_action>|CCA_name_action;
};
export type CCB={
/**
...
export type CCI_rangeXYZ=Array<JsonType>;
export type CCI={
/**
...
export type CDH=BAI;
export type CDI=BAI;
export type CDJ=Record<string,never>;
export type CEA={
/**
...
export type CEB=Record<string,never>;
export type CEC={
/**
*@default true
...
export type CEJ=Array<JsonType>;
export type CFA=string|{
/**
*@pattern ^[a-zA-Z0-9_\-:]+$
*@description The event to fire.
*/
...
*/
"seats"?:CFH_seats_spec|Array<CFH_seats_spec>;
};
export type CFI={
/**
*@default 1
...
*/
"entities"?:CGG_entity_spawn|Array<CGG_entity_spawn>;
};
export type CGH={
/**
...
export type CGJ=Record<string,never>;
export type CHA={
/**
*@default 1
...
export type CHB_auto_reject_items={
/**
...
*/
"auto_reject_items"?:CHB_auto_reject_items|Array<CHB_auto_reject_items>;
/**
...
*/
"feed_items"?:CHB_feed_items|Array<CHB_feed_items>;
/**
*@default 100
...
export type CHG=Record<string,never>;
export type CHH={
/**
*@description Determines when the mob transforms, if the trades should be converted when the new mob has a economy_trade_table. When the trades are converted, the mob will generate a new trade list with their new trade table, but then it will try to convert any of the same trades over to have the same enchantments and user data. For example, if the original has a Emerald to Enchanted Iron Sword (Sharpness 1), and the new trade also has an Emerald for Enchanted Iron Sword, then the enchantment will be Sharpness 1.
*/
...
export type CIG=Record<string,never>;
export type CIH=Record<string,never>;
export type CII={
/**
*@default 1
...
export type CIJ=Record<string,never>;
export type CJA={
/**
*@default 0.8
...
export type CJF_entity_definition={
"filters"?:BG;
/**
...
export type CJF=Array<CJF_entity_definition>|CJF_entity_definition;
export type CJE={
"priority"?:CJC;
/**
...
export type CJJ=number;
export type CJI={
"priority"?:CJC;
"speed_multiplier"?:CJJ;
};
export type DAA={
"priority"?:CJC;
"speed_multiplier"?:CJJ;
...
export type DAJ=Array<JsonType>;
export type DAI=DAJ|integer;
export type DAH={
"priority"?:CJC;
/**
...
*/
"on_stay_completed"?:Array<BAI>|BAI;
/**
*@description Event to run on block reached.
*/
"on_reach"?:Array<BAI>|BAI;
/**
*@default 1
...
export type EBH_sequence=Array<{
/**
...
"minecraft:angry"?:BAD;
"minecraft:annotation.break_door"?:BAE;
"minecraft:annotation.open_door"?:BAF;
"minecraft:area_attack"?:BAG;
"minecraft:attack_cooldown"?:BAH;
"minecraft:attack_damage"?:BAJ;
"minecraft:attack"?:BBA;
"minecraft:balloonable"?:BBC;
"minecraft:barter"?:BBD;
"minecraft:block_climber"?:BBE;
"minecraft:block_sensor"?:BBF;
"minecraft:boostable"?:BBH;
"minecraft:boss"?:BBI;
"minecraft:break_blocks"?:BBJ;
"minecraft:breathable"?:BCB;
"minecraft:breedable"?:BCD;
"minecraft:bribeable"?:BCG;
"minecraft:buoyant"?:BCH;
"minecraft:burns_in_daylight"?:BCI;
"minecraft:can_climb"?:BCJ;
"minecraft:can_fly"?:BDA;
"minecraft:can_power_jump"?:BDB;
"minecraft:celebrate_hunt"?:BDC;
"minecraft:collision_box"?:BDD;
"minecraft:color"?:BDE;
"minecraft:color2"?:BDF;
"minecraft:combat_regeneration"?:BDG;
"minecraft:conditional_bandwidth_optimization"?:BDH;
"minecraft:custom_hit_test"?:BDI;
"minecraft:damage_over_time"?:BDJ;
"minecraft:damage_sensor"?:BEA;
"minecraft:dash"?:BEB;
"minecraft:default_look_angle"?:BEC;
"minecraft:despawn"?:BED;
"minecraft:drying_out_timer"?:BEE;
"minecraft:dweller"?:BEF;
"minecraft:economy_trade_table"?:BEG;
"minecraft:entity_sensor"?:BEH;
"minecraft:environment_sensor"?:BEI;
"minecraft:equip_item"?:BEJ;
"minecraft:equipment"?:BFA;
"minecraft:equippable"?:BFC;
"minecraft:exhaustion_values"?:BFD;
"minecraft:experience_reward"?:BFE;
"minecraft:explode"?:BFF;
"minecraft:fall_damage"?:BFG;
"minecraft:fire_immune"?:BFH;
"minecraft:floats_in_liquid"?:BFI;
"minecraft:flocking"?:BFJ;
"minecraft:flying_speed"?:BGA;
"minecraft:follow_range"?:BGB;
"minecraft:friction_modifier"?:BGC;
"minecraft:game_event_movement_tracking"?:BGD;
"minecraft:genetics"?:BGE;
"minecraft:giveable"?:BGF;
"minecraft:ground_offset"?:BGG;
"minecraft:group_size"?:BGH;
"minecraft:grows_crop"?:BGI;
"minecraft:healable"?:BGJ;
"minecraft:health"?:BHA;
"minecraft:heartbeat"?:BHB;
"minecraft:hide"?:BHC;
"minecraft:home"?:BHD;
"minecraft:horse.jump_strength"?:BHE;
"minecraft:hurt_on_condition"?:BHF;
"minecraft:hurt_when_wet"?:BHG;
"minecraft:input_ground_controlled"?:BHH;
"minecraft:inside_block_notifier"?:BHI;
"minecraft:insomnia"?:BIA;
"minecraft:instant_despawn"?:BIB;
"minecraft:interact"?:BIC;
"minecraft:inventory"?:BID;
"minecraft:is_baby"?:BIE;
"minecraft:is_charged"?:BIF;
"minecraft:is_chested"?:BIG;
"minecraft:is_dyeable"?:BIH;
"minecraft:is_hidden_when_invisible"?:BII;
"minecraft:is_ignited"?:BIJ;
"minecraft:is_illager_captain"?:BJA;
"minecraft:is_saddled"?:BJB;
"minecraft:is_shaking"?:BJC;
"minecraft:is_sheared"?:BJD;
"minecraft:is_stackable"?:BJE;
"minecraft:is_stunned"?:BJF;
"minecraft:is_tamed"?:BJG;
"minecraft:item_controllable"?:BJH;
"minecraft:item_hopper"?:BJI;
"minecraft:jump.dynamic"?:BJJ;
"minecraft:jump.static"?:CAA;
"minecraft:knockback_resistance"?:CAB;
"minecraft:lava_movement"?:CAC;
"minecraft:leashable"?:CAD;
"minecraft:lookat"?:CAE;
"minecraft:loot"?:CAF;
"minecraft:managed_wandering_trader"?:CAG;
"minecraft:mark_variant"?:CAH;
"minecraft:mob_effect"?:CAI;
"minecraft:movement_sound_distance_offset"?:CAJ;
"minecraft:movement.amphibious"?:CBA;
"minecraft:movement.basic"?:CBB;
"minecraft:movement.fly"?:CBC;
"minecraft:movement.generic"?:CBD;
"minecraft:movement.glide"?:CBE;
"minecraft:movement.hover"?:CBF;
"minecraft:movement.jump"?:CBG;
"minecraft:movement.skip"?:CBH;
"minecraft:movement.sway"?:CBI;
"minecraft:movement"?:CBJ;
"minecraft:nameable"?:CCA;
"minecraft:navigation.climb"?:CCB;
"minecraft:navigation.float"?:CCC;
"minecraft:navigation.fly"?:CCD;
"minecraft:navigation.generic"?:CCE;
"minecraft:navigation.hover"?:CCF;
"minecraft:navigation.swim"?:CCG;
"minecraft:navigation.walk"?:CCH;
"minecraft:npc"?:CCI;
"minecraft:on_death"?:CCJ;
"minecraft:on_friendly_anger"?:CDA;
"minecraft:on_hurt_by_player"?:CDB;
"minecraft:on_hurt"?:CDC;
"minecraft:on_ignite"?:CDD;
"minecraft:on_start_landing"?:CDE;
"minecraft:on_start_takeoff"?:CDF;
"minecraft:on_target_acquired"?:CDG;
"minecraft:on_target_escape"?:CDH;
"minecraft:on_wake_with_owner"?:CDI;
"minecraft:out_of_control"?:CDJ;
"minecraft:peek"?:CEA;
"minecraft:persistent"?:CEB;
"minecraft:physics"?:CEC;
"minecraft:player.exhaustion"?:CED;
"minecraft:player.experience"?:CEE;
"minecraft:player.level"?:CEF;
"minecraft:player.saturation"?:CEG;
"minecraft:preferred_path"?:CEH;
"minecraft:projectile"?:CEI;
"minecraft:push_through"?:CFB;
"minecraft:pushable"?:CFC;
"minecraft:raid_trigger"?:CFD;
"minecraft:rail_movement"?:CFE;
"minecraft:rail_sensor"?:CFF;
"minecraft:ravager_blocked"?:CFG;
"minecraft:rideable"?:CFH;
"minecraft:scale_by_age"?:CFI;
"minecraft:scale"?:CFJ;
"minecraft:scheduler"?:CGA;
"minecraft:shareables"?:CGB;
"minecraft:shooter"?:CGC;
"minecraft:sittable"?:CGD;
"minecraft:skin_id"?:CGE;
"minecraft:sound_volume"?:CGF;
"minecraft:spawn_entity"?:CGG;
"minecraft:spell_effects"?:CGH;
"minecraft:strength"?:CGI;
"minecraft:suspect_tracking"?:CGJ;
"minecraft:tameable"?:CHA;
"minecraft:tamemount"?:CHB;
"minecraft:target_nearby_sensor"?:CHC;
"minecraft:teleport"?:CHD;
"minecraft:tick_world"?:CHE;
"minecraft:timer"?:CHF;
"minecraft:trade_resupply"?:CHG;
"minecraft:trade_table"?:CHH;
"minecraft:trail"?:CHI;
"minecraft:transformation"?:CHJ;
"minecraft:trust"?:CIA;
"minecraft:trusting"?:CIB;
"minecraft:type_family"?:CIC;
"minecraft:underwater_movement"?:CID;
"minecraft:variable_max_auto_step"?:CIE;
"minecraft:variant"?:CIF;
"minecraft:vibration_damper"?:CIG;
"minecraft:vibration_listener"?:CIH;
"minecraft:walk_animation_speed"?:CII;
"minecraft:wants_jockey"?:CIJ;
"minecraft:water_movement"?:CJA;
"minecraft:behavior.admire_item"?:CJB;
"minecraft:behavior.avoid_block"?:CJD;
"minecraft:behavior.avoid_mob_type"?:CJE;
"minecraft:behavior.barter"?:CJG;
"minecraft:behavior.beg"?:CJH;
"minecraft:behavior.break_door"?:CJI;
"minecraft:behavior.breed"?:DAA;
"minecraft:behavior.celebrate_survive"?:DAB;
"minecraft:behavior.celebrate"?:DAC;
"minecraft:behavior.charge_attack"?:DAD;
"minecraft:behavior.charge_held_item"?:DAE;
"minecraft:behavior.circle_around_anchor"?:DAF;
"minecraft:behavior.controlled_by_player"?:DAG;
"minecraft:behavior.croak"?:DAH;
"minecraft:behavior.defend_trusted_target"?:DBA;
"minecraft:behavior.defend_village_target"?:DBB;
"minecraft:behavior.delayed_attack"?:DBC;
"minecraft:behavior.dig"?:DBD;
"minecraft:behavior.door_interact"?:DBE;
"minecraft:behavior.dragonchargeplayer"?:DBF;
"minecraft:behavior.dragondeath"?:DBG;
"minecraft:behavior.dragonflaming"?:DBH;
"minecraft:behavior.dragonholdingpattern"?:DBI;
"minecraft:behavior.dragonlanding"?:DBJ;
"minecraft:behavior.dragonscanning"?:DCA;
"minecraft:behavior.dragonstrafeplayer"?:DCB;
"minecraft:behavior.dragontakeoff"?:DCC;
"minecraft:behavior.drink_milk"?:DCD;
"minecraft:behavior.drink_potion"?:DCE;
"minecraft:behavior.drop_item_for"?:DCF;
"minecraft:behavior.eat_block"?:DCG;
"minecraft:behavior.eat_carried_item"?:DCH;
"minecraft:behavior.eat_mob"?:DCI;
"minecraft:behavior.emerge"?:DCI;
"minecraft:behavior.enderman_leave_block"?:DCJ;
"minecraft:behavior.enderman_take_block"?:DDA;
"minecraft:behavior.equip_item"?:DDB;
"minecraft:behavior.explore_outskirts"?:DDC;
"minecraft:behavior.fertilize_farm_block"?:DDD;
"minecraft:behavior.find_cover"?:DDE;
"minecraft:behavior.find_mount"?:DDF;
"minecraft:behavior.find_underwater_treasure"?:DDG;
"minecraft:behavior.flee_sun"?:DDH;
"minecraft:behavior.float_wander"?:DDI;
"minecraft:behavior.float"?:DDJ;
"minecraft:behavior.follow_caravan"?:DEA;
"minecraft:behavior.follow_mob"?:DEB;
"minecraft:behavior.follow_owner"?:DEC;
"minecraft:behavior.follow_parent"?:DED;
"minecraft:behavior.follow_target_captain"?:DEE;
"minecraft:behavior.go_and_give_items_to_noteblock"?:DEF;
"minecraft:behavior.go_and_give_items_to_owner"?:DEG;
"minecraft:behavior.go_home"?:DEH;
"minecraft:behavior.guardian_attack"?:DEI;
"minecraft:behavior.harvest_farm_block"?:DEJ;
"minecraft:behavior.hide"?:DFA;
"minecraft:behavior.hold_ground"?:DFB;
"minecraft:behavior.hurt_by_target"?:DFC;
"minecraft:behavior.inspect_bookshelf"?:DFD;
"minecraft:behavior.jump_to_block"?:DFE;
"minecraft:behavior.knockback_roar"?:DFF;
"minecraft:behavior.lay_down"?:DFG;
"minecraft:behavior.lay_egg"?:DFH;
"minecraft:behavior.leap_at_target"?:DFI;
"minecraft:behavior.look_at_entity"?:DFJ;
"minecraft:behavior.look_at_player"?:DGA;
"minecraft:behavior.look_at_target"?:DGB;
"minecraft:behavior.look_at_trading_player"?:DGC;
"minecraft:behavior.make_love"?:DGD;
"minecraft:behavior.melee_attack"?:DGE;
"minecraft:behavior.mingle"?:DGF;
"minecraft:behavior.mount_pathing"?:DGG;
"minecraft:behavior.move_indoors"?:DGH;
"minecraft:behavior.move_outdoors"?:DGI;
"minecraft:behavior.move_through_village"?:DGJ;
"minecraft:behavior.move_to_block"?:DHA;
"minecraft:behavior.move_to_land"?:DHB;
"minecraft:behavior.move_to_lava"?:DHC;
"minecraft:behavior.move_to_liquid"?:DHD;
"minecraft:behavior.move_to_poi"?:DHE;
"minecraft:behavior.move_to_random_block"?:DHF;
"minecraft:behavior.move_to_village"?:DHG;
"minecraft:behavior.move_to_water"?:DHH;
"minecraft:behavior.move_towards_dwelling_restriction"?:DHI;
"minecraft:behavior.move_towards_home_restriction"?:DHJ;
"minecraft:behavior.move_towards_restriction"?:DIA;
"minecraft:behavior.move_towards_target"?:DIB;
"minecraft:behavior.nap"?:DIC;
"minecraft:behavior.nearest_attackable_target"?:DID;
"minecraft:behavior.nearest_prioritized_attackable_target"?:DIE;
"minecraft:behavior.ocelot_sit_on_block"?:DIF;
"minecraft:behavior.ocelotattack"?:DIG;
"minecraft:behavior.offer_flower"?:DIH;
"minecraft:behavior.open_door"?:DII;
"minecraft:behavior.owner_hurt_by_target"?:DIJ;
"minecraft:behavior.owner_hurt_target"?:DJA;
"minecraft:behavior.panic"?:DJB;
"minecraft:behavior.peek"?:DJC;
"minecraft:behavior.pet_sleep_with_owner"?:DJD;
"minecraft:behavior.pickup_items"?:DJE;
"minecraft:behavior.play_dead"?:DJF;
"minecraft:behavior.play"?:DJG;
"minecraft:behavior.player_ride_tamed"?:DJH;
"minecraft:behavior.raid_garden"?:DJI;
"minecraft:behavior.ram_attack"?:DJJ;
"minecraft:behavior.random_breach"?:EAA;
"minecraft:behavior.random_fly"?:EAB;
"minecraft:behavior.random_hover"?:EAC;
"minecraft:behavior.random_look_around_and_sit"?:EAD;
"minecraft:behavior.random_look_around"?:EAE;
"minecraft:behavior.random_sitting"?:EAF;
"minecraft:behavior.random_stroll"?:EAG;
"minecraft:behavior.random_swim"?:EAH;
"minecraft:behavior.ranged_attack"?:EAI;
"minecraft:behavior.receive_love"?:EAJ;
"minecraft:behavior.restrict_open_door"?:EBA;
"minecraft:behavior.restrict_sun"?:EBB;
"minecraft:behavior.rise_to_liquid_level"?:EBC;
"minecraft:behavior.roar"?:EBD;
"minecraft:behavior.roll"?:EBE;
"minecraft:behavior.run_around_like_crazy"?:EBF;
"minecraft:behavior.scared"?:EBG;
"minecraft:behavior.send_event"?:EBH;
"minecraft:behavior.share_items"?:EBI;
"minecraft:behavior.silverfish_merge_with_stone"?:EBJ;
"minecraft:behavior.silverfish_wake_up_friends"?:ECA;
"minecraft:behavior.skeleton_horse_trap"?:ECB;
"minecraft:behavior.sleep"?:ECC;
"minecraft:behavior.slime_attack"?:ECD;
"minecraft:behavior.slime_float"?:ECE;
"minecraft:behavior.slime_keep_on_jumping"?:ECF;
"minecraft:behavior.slime_random_direction"?:ECG;
"minecraft:behavior.snacking"?:ECH;
"minecraft:behavior.sneeze"?:ECI;
"minecraft:behavior.sonic_boom"?:ECJ;
"minecraft:behavior.squid_dive"?:EDA;
"minecraft:behavior.squid_flee"?:EDB;
"minecraft:behavior.squid_idle"?:EDC;
"minecraft:behavior.squid_move_away_from_ground"?:EDD;
"minecraft:behavior.squid_out_of_water"?:EDE;
"minecraft:behavior.stalk_and_pounce_on_target"?:EDF;
"minecraft:behavior.stay_near_noteblock"?:EDG;
"minecraft:behavior.stay_while_sitting"?:EDH;
"minecraft:behavior.stomp_attack"?:EDI;
"minecraft:behavior.stomp_turtle_egg"?:EDJ;
"minecraft:behavior.stroll_towards_village"?:EEA;
"minecraft:behavior.summon_entity"?:EEB;
"minecraft:behavior.swell"?:EEC;
"minecraft:behavior.swim_idle"?:EED;
"minecraft:behavior.swim_wander"?:EEE;
"minecraft:behavior.swim_with_entity"?:EEF;
"minecraft:behavior.swoop_attack"?:EEG;
"minecraft:behavior.take_flower"?:EEH;
"minecraft:behavior.target_when_pushed"?:EEI;
"minecraft:behavior.tempt"?:EEJ;
"minecraft:behavior.timer_flag_1"?:EFA;
"minecraft:behavior.timer_flag_2"?:EFA;
"minecraft:behavior.timer_flag_3"?:EFA;
"minecraft:behavior.random_search_and_dig"?:EFB;
"minecraft:behavior.trade_interest"?:EFC;
"minecraft:behavior.trade_with_player"?:EFD;
"minecraft:behavior.vex_copy_owner_target"?:EFE;
"minecraft:behavior.vex_random_move"?:EFF;
"minecraft:behavior.wither_random_attack_pos_goal"?:EFG;
"minecraft:behavior.wither_target_highest_damage"?:EFH;
"minecraft:behavior.work"?:EFI;
"minecraft:behavior.work_composter"?:EFJ;
};
export type EGA_addremove={
/**
*@description The components groups to add or remove.
*/
"component_groups"?:Array<string>;
};
export type EGA_event_base={
"filters"?:BG;
/**
...
[k:string]:any;
}|E|H|J|BA|BB|BC|BD|BE|BF|BG|BH|BI|BJ|CB|CD|CE|CF|CG|CH|CI|CJ|DA|DB|DC|DD|DE|DF|DG|DH|DI|DJ|EA|EB|EC|ED|EE|EF|EG|EH|EI|EJ|FA|FB|FC|FD|FE|FF|FG|FH|FI|FJ|GA|GB|GC|GD|GE|GF|GG|GH|GI|GJ|HA|HB|HC|HD|HE|HF|HG|HH|HI|HJ|IA|IB|IC|ID|IE|IF|IG|IH|II|IJ|JA|JsonType;
...
"event"?:string;
/**
*@description Event target (block).
*/
"target"?:string;
};
};
...
export type JE_difficulty=string;
export type JE={
/**
...
export type JF=Record<string,never>;
export type JG={
/**
...
export type JJ=JJ_herd|Array<JJ_herd>;
export type BAA={
/**
...
export type BAB=BAB_permute_type|Array<BAB_permute_type>;
export type BAC={
/**
*@description UNDOCUMENTED.
*/
...
export type BAF=Record<string,never>;
export type BAG=string|Array<string>;
export type BAH=string|Array<string>;
export type BAI=Record<string,never>;
export type BAJ=Record<string,never>;
export type BBA=Record<string,never>;
export type BBB={
/**
...
"minecraft:brightness_filter"?:JB;
"minecraft:delay_filter"?:JC;
"minecraft:density_limit"?:JD;
"minecraft:difficulty_filter"?:JE;
"minecraft:disallow_spawns_in_bubble"?:JF;
"minecraft:distance_filter"?:JG;
"minecraft:height_filter"?:JH;
"minecraft:entity_types"?:JI;
"minecraft:herd"?:JJ;
"minecraft:mob_event_filter"?:BAA;
"minecraft:permute_type"?:BAB;
"minecraft:player_in_village_filter"?:BAC;
"minecraft:spawn_event"?:BAD;
"minecraft:spawns_above_block_filter"?:BAE;
"minecraft:spawns_lava"?:BAF;
"minecraft:spawns_on_block_filter"?:BAG;
"minecraft:spawns_on_block_prevented_filter"?:BAH;
"minecraft:spawns_on_surface"?:BAI;
"minecraft:spawns_underground"?:BAJ;
"minecraft:spawns_underwater"?:BBA;
"minecraft:weight"?:BBB;
"minecraft:world_age_filter"?:BBC;
}>;
};
};
}
